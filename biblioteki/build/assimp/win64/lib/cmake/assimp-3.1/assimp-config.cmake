...
if( MSVC )
  ...
  set(ASSIMP_LIBRARY_SUFFIX "64-${MSVC_PREFIX}-mt" CACHE STRING "the suffix for the assimp windows library" FORCE)
else()
  set(ASSIMP_LIBRARY_SUFFIX "64" CACHE STRING "the suffix for the openrave libraries" FORCE)
endif()
